...
Anti cheat Samp Tidak sepenuhnya work tapi bisa dicoba

 [Link kode](https://github.com/DemasXI/anti-cheat-samp/blob/main/Anti%20cheat)
...
public OnFilterScriptInit()
{
	...
	print("------------------------------------------------------");
	print("-------------Anti Bot Attack By Deemas Now Loaded------");
	print("------------------------------------------------------");
	return 1;
}
